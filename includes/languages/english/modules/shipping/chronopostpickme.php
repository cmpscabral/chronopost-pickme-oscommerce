...
define(
	...
	'ChronoPost PickMe <span id="chronopostpickmeHolder"></span><script defer src="chronopostpickme.js"></script><script type="text/javascript">  $(document).ready(function() { $("#chronopostpickmeHolder").append(chronopostpickme.buildSelect()); });</script>'
);
?>
